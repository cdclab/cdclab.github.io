          ...
          <section id="joinus-volunteer" class="dark">
            <div class="card wrapper-horizontal flex-box flex-box-reverse">
              <div class="flex-60">
                ...
                <p>If you are interested, please write to us about yourselves and your research interest, together with your CV and latest transcript. Please send them to Yanbin (<span class="highlight">yb.cdclab@gmail.com</span>). Please note that only students who plan to work for a long period of time (e.g., over 1 year) will be considered. </p>
              </div>
