  ...
  data() {
    return {
      ...
      HonStaff: [
        ...
        { name: 'Rachel Chong', img: 'chong-rachel.webp', position: 'Honorary Clinical Consultant', description: 'Senior learner, research newbie. She loves stories of human experiences, which transformed into her research interest. She looks into children’s stories for more understanding of the development of ‘self’, especially their socioemotional development, and how childhood trauma affects one’s relational knowledge. Good food and cat cuddles made her day.' }, 
      ...
      CP: [
        ...
        { name: 'Peanut Wong', img: 'wong-peanut.jpg', position: 'M.S.Sc. in Clinical Psychology', description: 'She obtained her Bachelor’s Degree from CUHK. Her research interest concerns processes underlying how people relate to themselves and others, and how they impact people’s emotional wellbeing. She likes long walks only when it’s cool outside, and dinosaurs all year round.' },
      ],
      //MA: [
