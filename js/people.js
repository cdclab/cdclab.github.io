export default {
  ...
  data() {
    return {
      ...
      Staff: [
        { name: 'Harris Chung', img: 'chung-harris.webp', position: 'Research Assistant', description: 'He is interested in understanding the socio-cognitive process behinds human interaction. His has previously accomplished an undergraduate thesis that examining the underlying implication of heart rate variability on self-esteem within a social context. Understanding how world can be perceived in various perspectives is one of his primary curiosities. In his free time, he enjoys playing football and darts, taking film photos, and engaging in thought-provoking discussions with friends.', email: 'harris.cdclab@gmail.com', tel: '3943-3507'}
        ],
      HonStaff: [
