export default {
  ...
  data() {
    return {
      ...
      Staff: [
        { name: 'Peanut Wong', img: 'wong-peanut.webp', position: 'Research Assistant', description: 'She obtained her Bachelor’s Degree in Psychology in CUHK. She is interested in learning how people understand themselves in a world full of other human beings, and the patterns in which such understanding manifests in inter- and intrapersonal relationships. Her undergraduate thesis examined the relationship between representation coherence in moderating the advantages of flexible perspective switching for emotion recognition. She watches Haikyu(!!) to motivate herself.', email: 'peanut.cdclab@gmail.com', tel: '3943-3507'}
      ],
      HonStaff: [
